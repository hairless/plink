...
在 [Github](https://github.com/hairless/plink) 上面可以很方便地提交 [Pull Request (PR)](https://help.github.com/articles/about-pull-requests/)，下面介绍 Plink 项目的 PR 方法。

### 1. Fork仓库

进入 hairless/plink 的 [github 页面](https://github.com/hairless/plink) ，点击右上角按钮 `Fork` 进行 Fork。
...
```
git clone https://github.com/<your_github_name>/plink.git
```
...
#### （2）将 hairless/plink 添加为本地仓库的远程分支 upstream：

```
cd  plink
git remote add upstream https://github.com/hairless/plink.git
```
...
```
git remote -v
origin https://github.com/<your_github_name>/plink.git (fetch)
origin    https://github.com/<your_github_name>/plink.git (push)
upstream  https://github.com/hairless/plink.git (fetch)
upstream  https://github.com/hairless/plink.git (push)
```
...
#### （4）完成创建
创建成功后，您可以看到 Plink 项目需要 review，您可以等待我们 review 和合入，您也可以直接联系我们。
...
From https://github.com/hairless/plink
...
To https://lide-reed:fc35ff925bd8fd6629be3f6412bacee99d4e5f97@github.com/lide-reed/plink.git
...
remote:      https://github.com/lide-reed/plink/pull/new/my_branch
remote: 
To https://lide-reed:fc35ff925bd8fd6629be3f6412bacee99d4e5f97@github.com/lide-reed/plink.git
